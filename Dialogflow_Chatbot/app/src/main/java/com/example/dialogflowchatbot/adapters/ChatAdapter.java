package com.example.dialogflowchatbot.adapters;
...
import com.example.dialogflowchatbot.R;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    @Override public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(isReceived){
            ...
            holder.boogieProfile.setVisibility(View.VISIBLE);
            ...
            holder.boogieProfile.setVisibility(View.GONE);
        }
    }
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView boogieProfile;

        MyViewHolder(@NonNull View itemView) {
            super(itemView);
            messageSend = itemView.findViewById(R.id.message_send);
            messageReceive = itemView.findViewById(R.id.message_receive);
            boogieProfile = itemView.findViewById(R.id.boogieProfile);
        }
    }
